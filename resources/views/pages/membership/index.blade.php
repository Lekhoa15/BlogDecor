<x-guest-layout>
    <section class="container pt-16 mx-auto mb-32">
        ...
        <div class="grid grid-cols-3 gap-8 my-16">
            ...
            <div class="border border-gray-200 divide-y divide-gray-200 shadow-lg bg-gray-50">
                <div class="p-6">
                    ...
                    <span class="block mt-6 text-theme-blue-100">
                        {{ __('You are currently subscribed to our Free Plan') }}
                    </span>
                    @endnotsubscribed
                    @else
            ...
            <div class="border border-gray-200 divide-y divide-gray-200 shadow-lg bg-gray-50" x-data="{ showModal: false }">
                <div class="p-6">
                    ...
                    @endonTrial
                    @else
                    <x-link.primary class="mt-4 text-xl" href="#" @click="showModal = true">
                        Sign up
                    </x-link.primary>
    ...
    <!-- Modal -->
    <div x-show="showModal" class="fixed inset-0 z-50 flex items-center justify-center overflow-auto bg-black bg-opacity-50">
        <div class="p-6 bg-white rounded-lg">
            <h2 class="text-xl font-semibold leading-6 text-gray-900">Choose Payment Method</h2>
            <div class="mt-4 space-y-4">
                <a href="{{ route('payments.card', ['plan' => $plan->slug()]) }}" class="block p-2 text-center text-white bg-blue-500 rounded">Pay with Card</a>
                <a href="{{ route('payments.qr', ['plan' => $plan->slug()]) }}" class="block p-2 text-center text-white bg-green-500 rounded">Pay with QR Code</a>
            </div>
            <button @click="showModal = false" class="block mt-4 text-sm text-center text-gray-600 hover:text-gray-900">Cancel</button>
        </div>
    </div>
